...
# define the object which is message that passed between each node in the graph
...
# create researcher node and chart node from agent node
import functools
...
# invoking the multi-agent workflows
for s in graph.stream(
    {
        "messages": [
            HumanMessage(
                content = ("Tra cứu số lượng người dùng tiktok từ năm 2019 đến năm 2023,"
                           " sau khi có số liệu, vẽ biểu đồ đường để thể hiện số lượng người dùng."
                           "Sau khi có biểu đồ, finish bằng cách ghi 'FINAL ANSWER'."
                           )
                        )
        ],
    },
